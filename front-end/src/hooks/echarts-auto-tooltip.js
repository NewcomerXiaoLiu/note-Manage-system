(function (global) {
  ...
  tools.loopShowTooltip = function (chart, chartOption, options) {
    ...
    let dataIndex = 0; // 数据索引，初始化为0，是为了判断是否是第一次执行
    ...
    function autoShowTip() {
      ...
      function showTip() {
        ...
        if (!series || series.length === 0 || !currSeries || !currSeries.type || !currSeries.data || !currSeries.data.length) {
          return;
        }
